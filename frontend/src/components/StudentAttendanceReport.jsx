...
import { Calendar, BookOpen, Sunset, TrendingUp } from 'lucide-react';
import './ParentAttendanceReport.css'; // Reuse parent attendance styles
...
const StudentAttendanceReport = () => {
  ...
  const fetchAttendanceReport = async () => {
    try {
      ...
      // Build query params
      let url = 'http://127.0.0.1:8000/api/users/student/attendance-report/';
  ...
  const { student, session, statistics, attendance_records, holidays, available_sessions } = reportData;
    ...
    <div className="parent-attendance-container">
      <div className="parent-attendance-header">
        ...
        <div>
          ...
          <p>Track your school attendance records</p>
        </div>
      </div>
      ...
      <div className="attendance-info-card">
        ...
        <div className="info-item">
          ...
          <span className="info-value">{student.classroom || 'N/A'}</span>
        </div>
        <div className="info-item">
